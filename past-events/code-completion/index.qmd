...
image: "../docs/logo-mls.png"
---

This event was attended by 9 people all working in tech or using ML sysytems in some form. 
...
- Elliot pointed out how working with teams who use LLMs as part of their code review can be frustrating, because the tendency to pick up on small insignificant style errors rather than focussing on the big picture like a human would. 
